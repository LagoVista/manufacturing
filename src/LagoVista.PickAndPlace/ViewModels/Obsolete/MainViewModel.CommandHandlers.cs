...
namespace LagoVista.PickAndPlace.ViewModels
{
    public partial class MainViewModel
    {
        ...
        {
   //         Machine.GCodeFileManager.OpenFileAsync(Machine.PCBManager.Project.TopEtchingFile);
        ...
        {
     //       Machine.GCodeFileManager.OpenFileAsync(Machine.PCBManager.Project.BottomEtchingFile);
