...
namespace LagoVista.PickAndPlace.Interfaces.Services
{
    ...
    {
        void Circle(IMVImage<T> img, MVLocatedCircle circle, Size size, int thickness = 1);
        ...
        void DrawRect(IMVImage<T> img, MVLocatedRectangle p, System.Drawing.Color color);
