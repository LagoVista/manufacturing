...
namespace LagoVista.Manufacturing.Rest.Controllers
{
    ...
    public class PickAndPlaceJobController : LagoVistaBaseController
    {
        ...
        [HttpGet("/api/mfg/PickAndPlacejob/{id}")]
        ...
        [HttpGet("/api/mfg/PickAndPlacejob/factory")]
        ...
        [HttpDelete("/api/mfg/PickAndPlacejob/{id}")]
        ...
        [HttpPost("/api/mfg/PickAndPlacejob")]
        ...
        [HttpPut("/api/mfg/PickAndPlaceJob")]
        ...
        public Task<ListResponse<PickAndPlaceJobSummary>> GetEquomentForOrg()
        {
